...
class YellowViewController: UIViewController,MFMailComposeViewControllerDelegate {
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        if memoryTag.string(forKey: "flag") == "ON"{
            titlecontent.text = "休斯顿领事馆"
            Phone1.text = "咨询电话:"
            Phone2.text = "值班电话:"
            Email.text = "电子邮件:"
            Note.text = "(非工作时间及公共假日期间，仅供紧急联络使用)"
            Address.text = "使馆地址: 3417 Montrose Blvd, \nHouston, TX 77006"
        }
        else{
            titlecontent.text = "Chinese Embassy in Houston"
            Phone1.text = "Embassy call:"
            Phone2.text = "On Duty Call:"
            Email.text = "Email:"
            Note.text = "(Only for Emergency!)"
            Address.text = "Embassy Address: 3417 Montrose Blvd, \nHouston, TX 77006"
    ...
    func configuredMailComposeViewController() -> MFMailComposeViewController {
        ...
        //设置邮件地址、主题及正文
        mailComposeVC.setToRecipients(["OfficialVisaHouston@Gmail.com"])
