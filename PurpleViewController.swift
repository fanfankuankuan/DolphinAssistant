...
class PurpleViewController: UIViewController,MFMailComposeViewControllerDelegate {
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        if memoryTag.string(forKey: "flag") == "ON"{
            titlecontent.text = "洛杉矶领事馆"
            Phone1.text = "咨询电话:"
            Phone2.text = "紧急电话:"
            Email.text = "电子邮件:"
            Note.text = "(非工作时间及公共假日期间，仅供紧急联络使用)"
            Address.text = "使馆地址: 500 Shatto Place,\nLos Angeles, CA 90020"
        }
        else{
            titlecontent.text = "Chinese Embassy in Los Angeles"
            Phone1.text = "Embassy call:"
            Phone2.text = "Emergency Call:"
            Email.text = "Email:"
            Note.text = "(Only for Emergency!)"
            Address.text = "Embassy Address: 500 Shatto Place,\nLos Angeles, CA 90020"
    ...
    func configuredMailComposeViewController() -> MFMailComposeViewController {
        ...
        //设置邮件地址、主题及正文
        mailComposeVC.setToRecipients(["consulatelosangeles@gmail.com"])
