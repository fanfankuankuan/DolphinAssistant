...
class PinkViewController: UIViewController,MFMailComposeViewControllerDelegate {
    ...
    func configuredMailComposeViewController() -> MFMailComposeViewController {
        ...
        //设置邮件地址、主题及正文
        mailComposeVC.setToRecipients(["visa.sf@gmail.com"])
